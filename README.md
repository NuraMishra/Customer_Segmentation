...
* **High Value** → Frequent, recent, high spending
* **Loyal** → Consistent buyers
* **At Risk** → Inactive customers likely to churn
...
* Loyal customers have consistent purchase patterns
...
* Retention is a bigger opportunity than acquisition
...
This project demonstrates how **data-driven segmentation enables targeted marketing and improves customer retention**.
